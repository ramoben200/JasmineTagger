...
await app.send_message(chat_id=message.chat.id, text="Lütfen Beni Kullanmak İçin Güncellemelerim Kanalına Katılın!\n ve Kontrol etmek için tıklayın /start", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🤖 Güncellemeler Kanalına Katılın 🤖", url=f"https://t.me/{JasmineSup}")]]), parse_mode="markdown")
         return 1
      except Exception:
