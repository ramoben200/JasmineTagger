...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('༒︎ Muazzam| 𝐓𝙴𝐀𝙼 𓆙 ', 'https://t.me/MuazzamMedia')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot aktifdi bot hakda məlumatı @iamZ3NT4 dan ala bilərsən Versiya 1.7.5<<")
